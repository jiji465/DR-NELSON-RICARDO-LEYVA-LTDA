...
const Header: React.FC<HeaderProps> = ({ clientName, competence }) => {
  return (
    <header className="bg-[#1e3a8a] text-white pt-16 pb-24 print:pt-8 print:pb-12 shadow-2xl shadow-blue-900/20 print:shadow-none relative overflow-hidden">
      {/* Abstract background - hide on print to save ink/render issues */}
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-8 relative z-10">
        <div className="md:max-w-3xl">
          ...
          <h1 className="text-3xl md:text-5xl font-bold leading-tight mb-4 print:mb-2 tracking-tight text-white">
            {clientName}
          </h1>
        ...
        <div className="bg-white/10 backdrop-blur-lg px-6 py-4 rounded-xl border border-white/10 shadow-lg print:shadow-none print:bg-[#1e3a8a] print:border-white/20">
