...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pb-20 bg-slate-50 font-sans print:bg-white text-slate-800 selection:bg-[#C5A059] selection:text-white print:pb-0">
      <Header 
      ...
      <main className="max-w-6xl mx-auto px-6 md:px-8 -mt-16 relative z-20 space-y-8 print:w-full print:max-w-none print:px-0 print:mt-0">
        ...
        <section className="print:break-inside-avoid">
            <div className="grid lg:grid-cols-2 gap-8 items-stretch print:block print:space-y-8">
                <div className="print:break-inside-avoid">
                    <ComparisonChart data={COMPARISON_DATA} />
                </div>
                <div className="flex flex-col gap-8 print:break-inside-avoid">
